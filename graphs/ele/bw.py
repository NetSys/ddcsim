...
def main():
    ...
    print >>total_bw_file, "0,0"
    print >>lsr_bw_file, "0,0"
    print >>lsu_from_lsr_bw_file, "0,0"
    ...
    for l in stdin:
        ...
        lsr_cause = Decimal(Decimal(s[5].strip()) * lsu_size)
    ...
    total_density = lsu_density + ru_density + lsr_density
    total_size = (cum_lsu * lsu_size + cum_ru * ru_size + cum_lsr * lsr_size) / num_link_events / num_links
